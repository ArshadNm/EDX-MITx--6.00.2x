...
#         #array to calculate average viruses count
#         totalViruses = []
#         #run sim
...
#                     Fail: virus offspring should have resistance half of the time.
#                     Expected 50/100 to have resistance to drug2, got 0/100.
#                     """
